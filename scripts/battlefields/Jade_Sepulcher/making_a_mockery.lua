...
content.loot =
{
    ...
    {
        { itemId = xi.item.SQUARE_OF_POLYFLAN, weight = xi.loot.weight.HIGH },
        { itemId = xi.item.BUNDLE_OF_HOMUNCULUS_NERVES, weight = xi.loot.weight.NORMAL },
        { itemId = xi.item.GLASS_SHEET, weight = xi.loot.weight.LOW },
        { itemId = xi.item.PETRIFIED_LOG, weight = xi.loot.weight.LOW },
    },

    {
        { itemId = xi.item.SCROLL_OF_AERO_IV, weight = xi.loot.weight.NORMAL },
        { itemId = xi.item.SCROLL_OF_MAIDENS_VIRELAI, weight = xi.loot.weight.NORMAL },
        ...
        { itemId = xi.item.LOUDSPEAKER_II, weight = xi.loot.weight.VERY_LOW },
        { itemId = xi.item.ACCELERATOR_II, weight = xi.loot.weight.VERY_LOW },
        { itemId = xi.item.STABILIZER_II, weight = xi.loot.weight.VERY_LOW },
    },
    ...
    {
        { itemId = xi.item.COLIBRI_FEATHER, weight = xi.loot.weight.NORMAL },
    },

    {
        ...
        { itemId = xi.item.IYO_SCALE, weight = xi.loot.weight.LOW },
        { itemId = xi.item.SQUARE_OF_MOBLINWEAVE, weight = xi.loot.weight.LOW },
        { itemId = xi.item.ALUMINUM_SHEET, weight = xi.loot.weight.VERY_LOW },
        { itemId = xi.item.MYTHRIL_COIL, weight = xi.loot.weight.VERY_LOW },
    },

    {
        { itemId = xi.item.NONE, weight = xi.loot.weight.EXTREMELY_HIGH },
        { itemId = xi.item.IMMORTALS_CAPE, weight = xi.loot.weight.LOW },
        { itemId = xi.item.DEADEYE_GLOVES, weight = xi.loot.weight.LOW },
        { itemId = xi.item.LEECH_SCIMITAR, weight = xi.loot.weight.LOW },
        { itemId = xi.item.PIRATES_EARRING, weight = xi.loot.weight.LOW },
    },

    {
        { itemId = xi.item.CHUNK_OF_PLATINUM_ORE, weight = xi.loot.weight.VERY_HIGH },
        { itemId = xi.item.CHUNK_OF_DARKSTEEL_ORE, weight = xi.loot.weight.VERY_HIGH },
        { itemId = xi.item.CHUNK_OF_ADAMAN_ORE, weight = xi.loot.weight.NORMAL },
        { itemId = xi.item.CHUNK_OF_ORICHALCUM_ORE, weight = xi.loot.weight.LOW },
        { itemId = xi.item.DEMON_HORN, weight = xi.loot.weight.LOW },
    },
}
