...
xi.settings.map =
{
    ...
    -- 潜在能力を破るための武器スキル ポイント ベース (スキルチェーン前) - 整数のみ。公式は 5 です。
    WS_POINTS_BASE = 5,

    -- スキルチェイン要素ごとのウェポンスキルポイント - 整数のみ、公式は 2 です。
    ...
    -- 釣りスキルの上昇量に対する乗数。デフォルト値は1.0。
    FISHING_SKILL_AMOUNT_MULTIPLIER = 1.0,

    -- 釣り竿の破損確率に対する乗数 (0.0 で破損なし)
    FISHING_ROD_BREAK_CHANCE_MULTIPLIER = 1.0,

    -- 釣り竿が破損可能かどうか (false で破損しない)
    FISHING_ROD_BREAKABLE = true,
    ...
    TRIAL_WS_POINT_MESSAGE = '\x83\x67\x83\x89\x83\x43\x83\x41\x83\x8b\x57\x53\x92\x42\x90\xac\x82\xdc\x82\xc5\x81\x40%d/%d',
    -- トライアル達成メッセージ：トライアルWS回数を達成しました。報告しにいこう。
    TRIAL_FINISH_MESSAGE = '\x83\x67\x83\x89\x83\x43\x83\x41\x83\x8b\x57\x53\x89\xf1\x90\x94\x82\xf0\x92\x42\x90\xac\x82\xb5\x82\xdc\x82\xb5\x82\xbd\x81\x42\x95\xf1\x8d\x90\x82\xb5\x82\xc9\x82\xa2\x82\xb1\x82\xa4\x81\x42',
