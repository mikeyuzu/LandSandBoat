...
xi.settings.main =
{
    ...
    USE_PRE_2013_DEX_MULTIPLIER      = false, -- true/false. Falseでは、精度計算にDEXの75%を使用します。2013年以前はDEXの50%が使用されていました。
    USE_PRE_2013_STR_MULTIPLIER      = false, -- true/false. Falseでは、両手攻撃、片手メイン攻撃、遠距離攻撃のSTR係数は1.0、H2Hでは0.75、サブスロットの片手攻撃では0.5となります。Trueでは、STR係数は全般的に0.5となり、リリースから2013年半ばまでこの設定でした。
